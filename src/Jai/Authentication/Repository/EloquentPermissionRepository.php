...
class EloquentPermissionRepository extends EloquentBaseRepository
{
    ...
    public function __construct()
    {
        ...
        Event::listen(['repository.deleting','repository.updating'], '\Jai\Authentication\Repository\EloquentPermissionRepository@checkIsNotAssociatedToAnyUser');
        Event::listen(['repository.deleting','repository.updating'], '\Jai\Authentication\Repository\EloquentPermissionRepository@checkIsNotAssociatedToAnyGroup');
    ...
    /**
     * @param $obj
     * @throws \Jai\Authentication\Exceptions\PermissionException
     */
