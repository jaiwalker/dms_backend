<?php namespace Jai\Authentication\Seeds;
...
class DbSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->call('Jai\Authentication\Seeds\PermissionSeeder');
        $this->call('Jai\Authentication\Seeds\GroupsSeeder');
        $this->call('Jai\Authentication\Seeds\UserSeeder');
