    ...
    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                {{Form::open(array('url' => URL::action("Jai\Authentication\Controllers\AuthController@postReminder"), 'method' => 'post') )}}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 margin-top-10">
                        <a href="{{URL::Action('Jai\Authentication\Controllers\AuthController@getClientLogin')}}"><i class="fa fa-arrow-left"></i> Back to login</a>
                    </div>
                </div>
            </div>
        </div>
