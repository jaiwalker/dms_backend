...
use Jai\Authentication\Classes\Captcha\CaptchaValidator;
use Validator;
/**
...
class CaptchaValidatorTest extends TestCase {
    ...
    public function canValidateInputSuccesfullyAsLaravelValidator()
    {
        ...
        Validator::extend('captcha', 'Jai\Authentication\Tests\Unit\CaptchaImplementationStub@validateCaptcha');
    ...
    public function canValidateInputErrorsAsLaravelValidator()
    {
        ...
        $input = ["captcha_input" => $captcha_value];
        $rules = ["captcha_input" => "captcha"];
        Validator::extend('captcha', 'Jai\Authentication\Tests\Unit\CaptchaImplementationStub@validateCaptcha', $this->captcha_validator->getErrorMessage());
