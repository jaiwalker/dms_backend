...
use Jai\Authentication\Models\ProfileField;
use Jai\Authentication\Models\ProfileFieldType;
...
class CustomProfileRepositoryTest extends DbTestCase {
    ...
    public function setUp()
    {
        ...
        $users = $this->times(2)->make('Jai\Authentication\Models\User',(function (){return $this->getUserStub();}));
        $this->user_1=  $users[0];
        $this->user_2=  $users[1];
