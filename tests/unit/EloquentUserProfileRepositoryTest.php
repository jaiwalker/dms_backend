...
class EloquentUserProfileRepositoryTest extends DbTestCase
{
    ...
    {
        $users = $this->make('Jai\Authentication\Models\User', $this->getUserStub());
    ...
    /**
     * @test
     * @expectedException \Jai\Authentication\Exceptions\ProfileNotFoundException
     **/
    ...
    {
        $user = $this->make('Jai\Authentication\Models\User', $this->getUserStub())->first();
