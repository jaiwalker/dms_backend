...
use Jai\Authentication\Helpers\FileRouteHelper;
...
class FileRouteHelperTest extends DbTestCase
{
    ...
    {
        $users_created = $this->make('Jai\Authentication\Models\User', array_merge($this->getUserStub(), ["permissions" => $permissions]));
