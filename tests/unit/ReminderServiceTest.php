...
use Jai\Authentication\Services\ReminderService as Reminder;
use Mockery as m;
...
class ReminderServiceTest extends DbTestCase {
    ...
    /**
     * @test
     * @expectedException \Jai\Library\Exceptions\MailException
     */
    ...
    {
        $mock_mail = m::mock('Jai\Library\Email\MailerInterface')->shouldReceive('sendTo')
    ...
    {
        $users = $this->make('Jai\Authentication\Models\User');
        $user = $users[0];
