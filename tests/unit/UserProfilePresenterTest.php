...
class UserProfilePresenterTest extends DbTestCase
{
    ...
    {
        $this->user = $this->initializeUserHasher()->make('Jai\Authentication\Models\User', $this->getUserStub())->first();
        $this->user_profile = $this->make('Jai\Authentication\Models\UserProfile', $this->getUserProfileStub($this->user))->first();
    }
